...
if (!window.zeroOne && import.meta.env.DEV) {
  ...
  window.zeroOne = {
    getAppInfo: async () => ({ name: "ZERO ONE", version: "0.4.0-preview", platform: navigator.platform.toLowerCase().includes("mac") ? "darwin" : navigator.platform.toLowerCase().includes("linux") ? "linux" : "win32", packaged: false }),
