...
const { DEFAULT_LOCAL_MODEL, cleanChatMessages, cleanModelName, publicPullProgress } = require("./ollama-local.cjs");

describe("local Ollama boundary", () => {
  it("accepts normal model aliases and rejects path-like input", () => {
    assert.equal(cleanModelName(DEFAULT_LOCAL_MODEL), "qwen3:1.7b");
