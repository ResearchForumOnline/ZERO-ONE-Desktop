...
Working-tree product version: `7.9.2`.
...
- `RELEASE_EVIDENCE.md` — preserved 0.4.0 preview evidence and historical candidate records; never borrow hashes or tests across builds. Current release notes are version-specific files such as `RELEASE_NOTES_7.9.2.md`.

## Current boundary

- Product: `ZERO ONE` 7.9.2 source by `QUANTUMENCRYPTION1 LTD`; signed-candidate evidence remains pending.
